...
const Index: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <header className="w-full bg-black/40 backdrop-blur-xl border-b border-white/10 py-4 px-6 md:px-8">
        <div className="flex justify-between items-center">
          <div className="text-xl font-bold bg-gradient-to-r from-white via-white to-white/70 text-transparent bg-clip-text">
      ...
      <main className="flex-1 container mx-auto px-4 py-12 md:py-20">
        <div className="text-center mb-12 md:mb-20">
          <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tighter bg-gradient-to-r from-white via-white to-white/70 text-transparent bg-clip-text">
        ...
        <div className="glass-panel p-8 mb-16" style={{ animation: 'none' }}>
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="flex-1">
              <h2 className="text-3xl font-bold mb-4 tracking-tight">Role-Based Access Control</h2>
            ...
            <div className="flex-1 bg-gradient-to-br from-blue-900/20 to-purple-900/20 border border-white/10 rounded-xl p-6">
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to streamline your workforce management?</h2>
      ...
      <footer className="bg-black/40 backdrop-blur-xl border-t border-white/10 py-8 px-4">
        <div className="container mx-auto">
          <div className="text-center text-white/40 text-sm">
            &copy; 2023 Workforce Management System. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description }) => {
  return (
    <div className="glass-panel p-6 text-center" style={{ animation: 'none' }}>
