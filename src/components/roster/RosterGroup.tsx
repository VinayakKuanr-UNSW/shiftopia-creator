...
export const RosterGroup: React.FC<RosterGroupProps> = ({ group }) => {
  ...
  return (
    <div className="animate-fade-in">
      <div className={`rounded-lg p-4 ${getGroupCardClass()} hover-scale transition-all duration-300`}>
        <div 
        ...
        {isExpanded && (
          <div className="mt-4 space-y-4">
            {group.subGroups.map((subGroup) => (
              <RosterSubGroup key={subGroup.id} subGroup={subGroup} />
            ))}
